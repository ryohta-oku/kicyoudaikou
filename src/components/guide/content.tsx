...
export const GUIDE_CHAPTERS: GuideChapter[] = [
...

  {
    ...
    steps: [
      ...
      {
        label: <>読み取りが終わったら、PDFがパソコンに保存されます</>,
      },
    ],
    toConfirm: (
      <>
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        detail: <>「できたPDFをこの画面に入れる」と書いてある四角です。押すと、ファイルを入れる場所が画面の上に開きます。</>,
      },
      {
        label: <>出てきた四角の中に、<strong>PDFをドラッグして入れる</strong></>,
        detail: <>マウスでPDFをつかんで、四角の上まで運んで離します。「ファイルを選ぶ」を押して選んでも同じです。</>,
      },
      {
