...
CREATE TABLE "new_DocumentPage" (
    ...
    "taxLines" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_DocumentPage" ("amount", "correctedText", "date", "documentId", "id", "imageData", "imagePath", "isConfirmed", "isDoubleChecked", "memo", "noRegistrationNumber", "ocrText", "pageNumber", "registrationNumber", "tax") SELECT "amount", "correctedText", "date", "documentId", "id", "imageData", "imagePath", "isConfirmed", "isDoubleChecked", "memo", "noRegistrationNumber", "ocrText", "pageNumber", "registrationNumber", "tax" FROM "DocumentPage";
