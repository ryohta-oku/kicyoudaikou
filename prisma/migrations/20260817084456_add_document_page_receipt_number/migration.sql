...
INSERT INTO "new_DocumentPage" ("amount", "correctedText", "date", "documentId", "id", "imageData", "imagePath", "isConfirmed", "isDoubleChecked", "memo", "noRegistrationNumber", "ocrText", "pageNumber", "registrationNumber", "tax", "taxLines") SELECT "amount", "correctedText", "date", "documentId", "id", "imageData", "imagePath", "isConfirmed", "isDoubleChecked", "memo", "noRegistrationNumber", "ocrText", "pageNumber", "registrationNumber", "tax", "taxLines" FROM "DocumentPage";
